...
def upload():
    target = os.path.join(APP_ROOT, 'temp_scripts/')
...
def register():
    ...
    ct = cv2.imread('temp_scripts/ct.jpg', 0)
    mri = cv2.imread('temp_scripts/mri.jpg', 0)
    ...
    cv2.imwrite("temp_scripts/mri_registered.jpg", tr_Y_img)
...
def fusion():
    # Load MRI image
    mri_image = cv2.imread('temp_scripts/mri_registered.jpg')
    ...
    for i, a in enumerate([LL, LH, HL, HH]):
        path='temp_scripts/mri_'+str(i)+'.jpg'
        cv2.imwrite(path,a)

    # Load CT Image
    ct_image = cv2.imread('temp_scripts/ct.jpg')
    ...
    for i, a in enumerate([LL, LH, HL, HH]):
        path='temp_scripts/ct_'+str(i)+'.jpg'
        cv2.imwrite(path,a)

    input_images=[]
    mri = cv2.imread('temp_scripts/mri_0.jpg')
    mri = cv2.cvtColor(mri, cv2.COLOR_BGR2GRAY)

    ct = cv2.imread('temp_scripts/ct_0.jpg')
    ct = cv2.cvtColor(ct, cv2.COLOR_BGR2GRAY)
    input_images.append(mri)
    input_images.append(ct)
    FU = Fusion(input_images)
    fusion_img = FU.fuse()
    cv2.imwrite('temp_scripts/fusion_0.jpg', fusion_img)

    input_images=[]
    mri = cv2.imread('temp_scripts/mri_1.jpg')
    mri = cv2.cvtColor(mri, cv2.COLOR_BGR2GRAY)

    ct = cv2.imread('temp_scripts/ct_1.jpg')
    ct = cv2.cvtColor(ct, cv2.COLOR_BGR2GRAY)
    input_images.append(mri)
    input_images.append(ct)
    FU = Fusion(input_images)
    fusion_img = FU.fuse()
    cv2.imwrite('temp_scripts/fusion_1.jpg', fusion_img)

    input_images=[]
    mri = cv2.imread('temp_scripts/mri_2.jpg')
    mri = cv2.cvtColor(mri, cv2.COLOR_BGR2GRAY)

    ct = cv2.imread('temp_scripts/ct_2.jpg')
    ct = cv2.cvtColor(ct, cv2.COLOR_BGR2GRAY)
    input_images.append(mri)
    input_images.append(ct)
    FU = Fusion(input_images)
    fusion_img = FU.fuse()
    cv2.imwrite('temp_scripts/fusion_2.jpg', fusion_img)

    input_images=[]
    mri = cv2.imread('temp_scripts/mri_3.jpg')
    mri = cv2.cvtColor(mri, cv2.COLOR_BGR2GRAY)

    ct = cv2.imread('temp_scripts/ct_3.jpg')
    ct = cv2.cvtColor(ct, cv2.COLOR_BGR2GRAY)
    input_images.append(mri)
    input_images.append(ct)
    FU = Fusion(input_images)
    fusion_img = FU.fuse()
    cv2.imwrite('temp_scripts/fusion_3.jpg', fusion_img)
    
    fusion_0 = cv2.imread('temp_scripts/fusion_0.jpg')
    fusion_0 = cv2.cvtColor(fusion_0, cv2.COLOR_BGR2GRAY)

    fusion_1 = cv2.imread('temp_scripts/fusion_1.jpg')
    fusion_1 = cv2.cvtColor(fusion_1, cv2.COLOR_BGR2GRAY)

    fusion_2 = cv2.imread('temp_scripts/fusion_2.jpg')
    fusion_2 = cv2.cvtColor(fusion_2, cv2.COLOR_BGR2GRAY)

    fusion_3 = cv2.imread('temp_scripts/fusion_3.jpg')
    fusion_3 = cv2.cvtColor(fusion_3, cv2.COLOR_BGR2GRAY)

    coeffs=(fusion_0,(fusion_1,fusion_2,fusion_3))
    fusion=pywt.idwt2(coeffs,'haar')
    cv2.imwrite('temp_scripts/fusion.jpg',fusion)
...
def classification():
    ...
    image=cv.imread('temp_scripts/fusion.jpg')   
    ...
    #print(dict_1)
    #classification()
    im1 = cv2.imread('temp_scripts/fusion.jpg')
    cv2.imwrite("temp_scripts/classified.jpg",im1)
